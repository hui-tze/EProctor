import cv2
import numpy as np
from liveness_verification import f_utils, config as cfg

frontal_face = cv2.CascadeClassifier('C:/Users/User/Documents/GitHub/EProctor/liveness_verification/profile_detection/haarcascades/haarcascade_frontalface_alt.xml')
profile_face = cv2.CascadeClassifier('C:/Users/User/Documents/GitHub/EProctor/liveness_verification/profile_detection/haarcascades/haarcascade_profileface.xml')


def detect(img, cascade):
    rects, _, confidence = frontal_face.detectMultiScale3(img, scaleFactor=1.3, minNeighbors=4, minSize=(30, 30),
