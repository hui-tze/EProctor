import cv2
from liveness_verification import f_utils
import dlib
import numpy as np
from liveness_verification.profile_detection import f_detector
from liveness_verification.blink_detection import f_blink_detection
...
def detect_liveness(im, COUNTER=0, TOTAL=0):
    ...
    output = {
        ...
        'total_blinks': TOTAL,
        'count_blinks_consecutive': COUNTER
    }
    return output
